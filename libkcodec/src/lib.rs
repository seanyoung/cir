...
pub fn encode(proto: rc_proto, scancode: u32) -> Vec<u32> {
    ...
    let len = match proto {
        rc_proto::RC_PROTO_RC5 | rc_proto::RC_PROTO_RC5X_20 | rc_proto::RC_PROTO_RC5_SZ => unsafe {
            ir_rc5_encode(proto, scancode, raw.as_mut_ptr(), raw.len() as u32)
        },
        rc_proto::RC_PROTO_JVC => unsafe {
            ir_jvc_encode(proto, scancode, raw.as_mut_ptr(), raw.len() as u32)
        },
        rc_proto::RC_PROTO_SONY12 | rc_proto::RC_PROTO_SONY15 | rc_proto::RC_PROTO_SONY20 => unsafe {
            ir_sony_encode(proto, scancode, raw.as_mut_ptr(), raw.len() as u32)
        },
        rc_proto::RC_PROTO_NEC | rc_proto::RC_PROTO_NECX | rc_proto::RC_PROTO_NEC32 => unsafe {
            ir_nec_encode(proto, scancode, raw.as_mut_ptr(), raw.len() as u32)
        },
        rc_proto::RC_PROTO_SHARP => unsafe {
            ir_sharp_encode(proto, scancode, raw.as_mut_ptr(), raw.len() as u32)
        },
        rc_proto::RC_PROTO_SANYO => unsafe {
            ir_sanyo_encode(proto, scancode, raw.as_mut_ptr(), raw.len() as u32)
        },
        rc_proto::RC_PROTO_RC6_0
        | rc_proto::RC_PROTO_RC6_6A_20
        | rc_proto::RC_PROTO_RC6_6A_24
        | rc_proto::RC_PROTO_RC6_6A_32
        | rc_proto::RC_PROTO_RC6_MCE => unsafe {
            ir_rc6_encode(proto, scancode, raw.as_mut_ptr(), raw.len() as u32)
        },
        rc_proto::RC_PROTO_RCMM12 | rc_proto::RC_PROTO_RCMM24 | rc_proto::RC_PROTO_RCMM32 => unsafe {
            ir_rcmm_encode(proto, scancode, raw.as_mut_ptr(), raw.len() as u32)
        },
        rc_proto::RC_PROTO_IMON => unsafe {
            ir_imon_encode(proto, scancode, raw.as_mut_ptr(), raw.len() as u32)
        },
